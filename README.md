...
2. Скануйте QR-код телефоном (відкриється сторінка `http://192.168.4.1/?deviceId=...`)
3. Введіть отриманий Device ID на порталі ESP8266 для налаштування
4. Після підключення пристрою до Wi-Fi, натисніть **"Підтвердити підключення"** на сайті
5. Пристрій автоматично з'явиться у списку з статусом "online"
