...
export function AuthForm() {
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background to-muted">
        <Card className="w-full max-w-md gradient-card border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              Введіть вашу email адресу для отримання інструкцій
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleResetPassword} className="space-y-4">
              ...
              <Button type="submit" className="w-full" disabled={resetLoading}>
                {resetLoading ? 'Надсилання...' : 'Надіслати інструкції'}
              </Button>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background to-muted">
      <Card className="w-full max-w-md gradient-card border-border/50">
        <CardHeader>
          <CardTitle>Grow Box Technology</CardTitle>
          <CardDescription>
          ...
          <Tabs defaultValue="signin" className="w-full">
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="signup-name">Повне ім'я (опційно)</Label>
                  <div className="relative">
                ...
                <Button type="submit" className="w-full" disabled={signUpLoading}>
                  {signUpLoading ? 'Реєстрація...' : 'Зареєструватися'}
                </Button>
              </form>
            </TabsContent>
          </Tabs>
